	      ...
	      <div class="slider-item ">
	        ...
	        <div class="container">
	          <div class="row d-md-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
	          	<div class="one-third js-fullheight order-md-last img" style="background-image:url({{ $info->hero_image ? asset('storage/'.$info->hero_image) : asset('assets/images/bg_1.png') }});">
	          		<div class="overlay"></div>
	          	</div>
		          <div class="one-forth d-flex  align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text">
		          		<span class="subheading">Hello!</span>
			            <h1 class="mb-4 mt-3">I'm <span>{{ $info->name ?? 'Clark Thompson' }}</span></h1>
    			...
    			<div class="col-md-6 col-lg-7 pl-lg-5 pb-5">
		          ...
		          <div class="col-md-12 heading-section ftco-animate">
		            ...
		            <ul class="about-info mt-4 px-md-0 px-2">
		            	<li class="d-flex"><span>Name:</span> <span>{{ $info->name ?? 'Clark Thompson' }}</span></li>
		            	...
		            	<li class="d-flex"><span>Email:</span> <span>{{ $info->email ?? 'clarkthomp@gmail.com' }}</span></li>
